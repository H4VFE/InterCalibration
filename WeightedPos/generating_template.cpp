...
void generating_template(){
  ...
  TFile *file = new TFile("/afs/cern.ch/user/k/kyee/work/vfe_55_WC7277.root"); 
  ...
  TProfile *mean_waveform = new TProfile("mean waveform - B3 - 100 GeV - 1*1 cm^2 at center","mean waveform - B3 - 100 GeV - 1*1 cm^2 at center;time(ns)",nsamples,-0.5,937);
  ...
  TH1F *interpolated_mean_waveform = new TH1F("interpolated mean waveform - B3 - 100 GeV - 1*1 cm^2 at center","interpolated mean waveform - B3 - 100 GeV - 1*1 cm^2 at center;time(ns)",nTempBins,-0.125,937.375);
  ...
  TFile *template_file = new TFile("/afs/cern.ch/user/k/kyee/work/template_July2017_B3_100.root","recreate");
  template_file->cd();
  mean_waveform->Write();
  template_file->Close();
}
